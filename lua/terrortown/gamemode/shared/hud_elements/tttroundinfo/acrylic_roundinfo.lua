...
if CLIENT then
	...
	function HUDELEMENT:Draw()
		...
		if is_haste then
			draw.AdvancedText(L.hastemode, "AcrylicMSTACKMsg", tmpx, self.pos.y + self.pad_roundinfo, COLOR_WHITE, TEXT_ALIGN_CENTER, TEXT_ALIGN_TOP, true, self.scale)
		end
	end
end
